...
| **Recommendations** | Posts you've recommended ("reposted"), newest-recommended first — see [Recommending](/using/reading/#recommending) |
...
Changing your password sends a security notice to your login address. If you
didn't make the change, follow the reset link in that email immediately.
