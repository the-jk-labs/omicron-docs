...
whose title is _"Making sure you're not a bot!"_ means the
...
<Callout type="warning" title="Scrub before you share">
  Logs can contain email addresses, domains, and — in `console` email mode — password-reset links. Read through them
