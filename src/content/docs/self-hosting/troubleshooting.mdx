...
If the tags are missing and the response is small, the
[scraper shield](/self-hosting/security/) served a challenge page instead of the
article — its title is *"Making sure you're not a bot!"*. If the tags are there,
